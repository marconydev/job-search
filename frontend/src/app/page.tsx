...
import {
  PainelVagas
} from "@/components/painel/painel-vagas"
...
/**
 * Eu mantenho esta página dinâmica porque os dados vêm do PostgreSQL
 * através da API e precisam refletir mudanças de status imediatamente.
 */
